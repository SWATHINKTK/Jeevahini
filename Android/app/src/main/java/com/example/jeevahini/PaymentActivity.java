...
public class PaymentActivity extends Activity implements PaymentResultWithDataListener, ExternalWalletListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        e1=findViewById(R.id.et_custom_options);
        ...
        try {
            amt = getIntent().getStringExtra("p");
//                    .split(".")[0];
        }
        catch (Exception e)
        {
...
//         Toast.makeText(getApplicationContext(),amt+"==amount",Toast.LENGTH_SHORT).show();
...
//                Toast.makeText(PaymentActivity.this, "rzp_amount"+amt, Toast.LENGTH_SHORT).show();
...
//        EditText etApiKey = findViewById(R.id.et_api_key);
        ...
        if (!TextUtils.isEmpty(etCustomOptions.getText().toString())){
            ...
            try {
                ...
                preFill.put("contact", "7994546435");
...
//                                edp.commit();
                ...
                protected Map<String, String> getParams() {
                    ...
                    params.put("amt",amt);
                    params.put("rid", getIntent().getStringExtra("req_id"));
